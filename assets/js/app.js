   ...
   el:'#app',
    ...
    methods:{
        ...
        intervalFetchData: function () {
         ...
         showAll(){
             axios.get(this.url+"chat/showAll").then(function(response){
          ...
          addUser(){
            var formData = v.formData(v.newUser);
              axios.post(this.url+"login/process", formData).then(function(response){
        ...
        sendMessage(){
            var formData = v.formData(v.chatMessage);

            axios.post(this.url+"chat/sendMessage", formData).then(function(response){
